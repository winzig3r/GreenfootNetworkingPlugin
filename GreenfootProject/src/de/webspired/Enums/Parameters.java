...
public enum Parameters {
    ...
    NewImageFilePath,
    /**
     * Used by the de.webspired.Client who created the de.webspired.Server to tell the de.webspired.Server what worlds are there
     * Used by the de.webspired.Server to tell new connecting clients about the worlds they can put their actors in
